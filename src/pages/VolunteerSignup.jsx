    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto grid max-w-6xl items-start gap-16 px-6 py-16 lg:grid-cols-2">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <dl className="mt-12 divide-y divide-border border-t border-border hidden">
            {HIGHLIGHTS.map(({ title, text }) =>
            <div key={title} className="py-5 hidden">
        ...
        <motion.div
          ...
          <div className="border-t border-border pt-10 hidden">
