      ...
      <main>
        <section className="relative overflow-hidden bg-teal-950 px-4 py-16 sm:px-6 lg:py-24">
          ...
          <div className="relative z-10 mx-auto max-w-3xl text-center text-white">
            ...
            <Link to="/explore" className="mt-8 inline-flex items-center gap-2 rounded-md bg-white px-6 py-3 text-sm font-bold text-teal-900 shadow-md hover:bg-teal-50">Explore <ArrowRight className="h-4 w-4" /></Link>
          </div>
        </section>
